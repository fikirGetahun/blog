      ...
      <main class="posts-listing col-lg-8"> 
        <div class="container">
          ...
          <div class="post col-xl-6">
              <div class="post-thumbnail"><a href="blogView.php?blog=<?php echo $row['id'] ?>"><img src="<?php $p = $admin->photoSplit($row['photoPath1']); echo $p[0] ;?>" alt="..." class="img-fluid"></a></div>
